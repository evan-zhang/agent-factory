...
|---|---|---|---|---|---|
| bp-unified | BP 统一工作平台 | v1.0.0 | — | 🔧 待发布 | 审计+评估+管理三大流程统一入口 |
| bp-auditor | BP 两级联动审计 | v1.0.0 | — | 🔧 待发布 | 两级联动 BP 审计工具（专用） |
| bp-manager | BP 管理工具 | — | — | S3 设计中 | 查询/管理 BP 目标/成果/举措（专用） |
...
| bp-unified | `05_products/bp-unified/` | — | 🔧 在建 |
...
### bp-unified — BP 统一工作平台（在建）
- 定位：审计+评估+管理三大流程的统一入口，按触发词路由
- 核心能力：深度审计（两级联动）+ 结构化评分（P0/P1/P2）+ CRUD 管理
