...
| **S3: 方案设计 (Design)** | 制定技术方案、数据流、接口规范 | 设计总工 | `DESIGN-01` |
  - 如涉及外部 API，必须从官方文档获取唯一权威来源
  - 禁止使用本地文档或记忆推断 API 规范 |
...
| v4.7 | 2026-04-06 | **唯一真相源原则**：在 S3 方案设计阶段加入"唯一真相源"要求；涉及外部 API 的 Skill，必须从官方文档获取唯一权威来源，禁止使用本地文档或记忆推断 | Zaowu |
