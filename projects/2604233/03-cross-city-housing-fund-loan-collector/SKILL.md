...
description: 使用内置 references 模块文档逐渠道采集中国城市“公积金异地贷款”政策信息。适用于用户提供目标城市和年份/时间范围后，围绕异地缴存职工在指定城市申请住房公积金贷款购房的支持范围、贷款额度、贷款利率、最低缴存时长和购房合同要求等指标使用 搜索工具检索官方与辅助来源、保留完整来源声明，并写入固定目录下 3 个 Markdown 文件且不做最终政策裁决的场景。
---
