...
description: 使用内置 references 模块文档逐渠道采集中国城市“落户”政策信息。适用于用户提供目标城市和年份/时间范围后，围绕本科学历在职员工通过人才引进或积分落户方式申请落户的可申请性、社保要求、社保年限、断缴补缴规则和积分落户社保加分规则等指标使用 搜索工具检索官方与辅助来源、保留完整来源声明，并写入固定目录下 3 个 Markdown 文件且不做最终政策裁决的场景。
---
